              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-12 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Input name="phone" type="tel" placeholder="0400 000 000" required className="bg-white border-muted h-14 rounded-none focus:ring-secondary focus:border-secondary" />
                  </div>
                </div>
